...
Template.pos_saleDetailReport.onRendered(function () {
    var name = $('[name="date"]');
    DateTimePicker.dateRange(name);
});
Template.pos_saleDetailReport.helpers({
...
Template.pos_saleDetailReportGen.helpers({
    options: function () {
    ...
    data: function () {
        ...
        var call = Meteor.callAsync(callId, 'posSaleDetailReport', q);
